...
params.show_feedback_during_iti     = 0; % boolean, show feedback (correct or incorrect) during ITI?  only makes sense for a set of pre-experiment practice trials.
...
params.runid  = input('Enter Run (reset daily):');
