% this script is based off of PAL_PFML_Demo
% but setup to use the data formatted by psychometric_from_staircase for
% the DSCI experiemnt.
...
ParOrNonPar = 2; % default to non-parametric bootstrap
